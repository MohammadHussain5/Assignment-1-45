...
function make_shirt(size:number, text:any){
    console.log(`Your shirt size number is ${size} & do you want to print this "${text}" text on your shirt`);
    
}

make_shirt(40,"Work hard, and may Allah grant you the results.");